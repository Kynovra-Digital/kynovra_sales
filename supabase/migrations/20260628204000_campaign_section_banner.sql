...
comment on column public.campaigns.section_banner_url is
  'Public storefront section banner image URL. Distinct from banner_url, which is used by the storefront hero slider.';
